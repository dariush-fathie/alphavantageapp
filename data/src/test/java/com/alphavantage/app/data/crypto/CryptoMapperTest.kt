        ...
        data = CryptoSeries(
            ...
            items = listOf(
                CryptoSeriesItem(
                    ...
                    openMarketValue = 64289.49655200,
                    openUsdValue = 9140.86000000,
                    highMarketValue = 66911.61417600,
                    highUsdValue = 9513.68000000,
                    lowMarketValue = 56286.69960000,
                    lowUsdValue = 8003.00000000,
                    closeMarketValue = 57258.05485200,
                    closeUsdValue = 8141.11000000,
                    volume = 722441.84657300,
                    usdMarketCap = 722441.84657300
                ),
                CryptoSeriesItem(
                    date = DateUtils.parseStringToDate("2019-10-31", null, "yyyy-MM-dd"),
                    openMarketValue = 58305.01700400,
                    openUsdValue = 8289.97000000,
                    highMarketValue = 72934.28400000,
                    highUsdValue = 10370.00000000,
                    lowMarketValue = 51342.36000000,
                    lowUsdValue = 7300.00000000,
                    closeMarketValue = 64289.42622000,
                    closeUsdValue = 9140.85000000,
